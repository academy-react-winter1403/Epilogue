...
const DetailBlog = ({newsId, blog}) => {
  ...
  return (
    <section className="w-full flex flex-col gap-6 lg:gap-8 px-4 sm:px-6 lg:px-8 justify-center items-center">
        ...
        <div className=' w-full mr-[-40px] md:self-start flex flex-col gap-4 lg:gap-6 justify-center items-start'>
            ...
            <div className="w-[50%] md:w-full lg:w-full font-dana font-medium lg:text-lg leading-[100%] tracking-[0%] font-weight: 500; font-size: 16px; line-height: 100%; letter-spacing: 0%; text-align: right text-black ">{blog?.detailsNewsDto.describe}</div>
