        ...
        <div className="w-[183px] md:w-[244px] h-[34px] md:h-[46px] font-bold text-2xl sm:text-3xl lg:text-4xl text-black mr-[-40px] md:mr-[10px] lg:mr-[0] self-start md:self-start lg:self-start whitespace-nowrap"><h2>{blog?.detailsNewsDto.title}</h2></div>
            ...
            <div className="lg:w-[600px] md:w-[550px] border-2 border-transparent rounded-[16px] flex flex-col gap-5 md:flex-row lg:flex-row md:border-gray-400 md:border-gray-400 lg:border-gray-400 md:gap-0 lg:gap-0">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] border-2 flex gap-7 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className="md:pr-15 lg:pr-10 pr-15 pt-2 w-[60px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-gray-800 whitespace-nowrap"> بازدیدکنندگان</div>
            ...
            <div className="self-start mr-[-85px] md:mr-[-5px] border-2 border-transparent rounded-[16px] md:border-gray-400 ">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'> 
                            <div className='pr-3 pt-2 w-[45px] h-[20px] font-medium text-[14px] leading-[100%] text-gray-800 whitespace-nowrap'> تعداد لایک</div>
                            <div className="pr-3 pt-2 w-[124px] h-[23px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right text-black whitespace-nowrap">{blog?.detailsNewsDto.currentLikeCount}</div>
                        </div>
                        <div className="w-[80px] h-0 border-2 -rotate-90 border-gray-400 relative top-[-23px] left-[-120px] md:top-[-22.5px] md:left-[-130px]"></div>
                    </div>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className="md:pr-8 pr-5 pt-2 w-[58px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-gray-800 whitespace-nowrap"> تعداد دیسلایک</div>
                        <div className="md:pr-8 pr-5 pt-2 w-[96px] h-[23px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right text-black whitespace-nowrap">{blog?.detailsNewsDto.currentDissLikeCount}</div>
                    </div>

                </div>
            </div>
            
            <div className="w-full md:h-[34px] h-[29px] flex justify-between">
