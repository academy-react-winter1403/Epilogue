    ...
    <div className="w-[50%] max-w-2xl xl:max-w-4xl h-auto p-4 sm:p-6 flex flex-col justify-between items-center gap-4">
      ...
      <div className="lg:w-[600px] md:w-[550px] border-2 border-transparent rounded-[16px] flex flex-col gap-5 md:flex-row lg:flex-row md:border-gray-400 md:border-gray-400 lg:border-gray-400 md:gap-0 lg:gap-0">
        <div className="w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]">
          <div>
            <div className="flex flex-col gap-4">
              <div className="w-[45px] h-[20px] font-medium text-[14px] leading-[100%] text-[var(--text-grey)] pr-3 pt-2 whitespace-nowrap">
                {" "}
                دسته بندی
              </div>
          ...
          <div>
            <div className="md:pr-4 pr-6 pt-2 w-[58px] h-[20px] font-dana font-medium text-[14px] text-[var(--text-grey)] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">
              منتشر کننده
            </div>
        ...
        <div className="w-[361px] md:w-[325px] lg:w-[325px] h-[80px] border-2 flex gap-7 border-gray-400 md:border-transparent rounded-[16px]">
          <div>
            <div className="flex flex-col gap-4">
              <div className="md:pr-[-20px] lg:pr-[5px] mr-3 pt-2 w-[76px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-[var(--text-grey)] whitespace-nowrap">
                تاریخ انتشار
              </div>
          ...
          <div>
            <div className="flex flex-col gap-4">
              <div className="mr-[-40px] md:mr-0 md:pr-7 pr-15 pt-2 w-[60px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-[var(--text-grey)] whitespace-nowrap">
                {" "}
                بازدیدکنندگان
              </div>
      ...
      <div className="self-start mr-[-85px] md:mr-[-5px] border-2 border-transparent rounded-[16px] md:border-gray-400 ">
        <div className="mr-9 w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]">
          <div>
            <div className="flex flex-col gap-4">
              <div className="pr-3 md:mr-[-35px] pt-2 w-[45px] h-[20px] font-medium text-[14px] leading-[100%] text-[var(--text-grey)] whitespace-nowrap">
                {" "}
                تعداد لایک
              </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="md:pr-8 pr-5 pt-2 md:mr-[15px]  w-[58px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-[var(--text-grey)] whitespace-nowrap">
              {" "}
              تعداد دیسلایک
            </div>
            <div className="md:pr-8 pr-5 pt-2 md:mr-[15px]  w-[96px] h-[23px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">
      ...
      <div className="w-full flex gap-2 items-center justify-center">
        ...
        <BlogFavorite
          newsId={newsId}
          isFav={blog?.detailsNewsDto?.isCurrentUserFavorite}
        />
        <LikeDislikeBlog
          likeId={blog?.detailsNewsDto?.likeId}
          newsId={newsId}
          currentLikeCount={blog?.detailsNewsDto?.currentUserIsLike}
          currentDissLikeCount={blog?.detailsNewsDto?.currentUserIsDissLike}
        />
      </div>
    </div>
  );
