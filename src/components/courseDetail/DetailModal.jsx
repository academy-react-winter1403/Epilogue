        ...
        <AnimatePresence mode='wait'> 
            {isModalOpen && (
                ...
                >
                    ...
                    <div className='absolute w-[330px] h-[29px] lg:top-[24px] lg:left-[50px] top-[40px] left-[40px] font-dana font-bold text-[20px] leading-[100%] tracking-[0%] text-right text-blue-500 whitespace-nowrap'> <h2>{t('courseAddedToReserveList')}</h2></div> 
                    <div className='flex flex-col'>
                        ...
                        <div>
                            ...
                            <span className='text-black absolute md:top-[140px] md:left-[320px] top-[165px] left-[310px]'>{t('myReserve')}</span> 
                        </div>
                        ...
                        <div>
                            ...
                            <span className='text-black absolute md:top-[240px] md:left-[320px] top-[268px] left-[310px]'>{t('myCourses')}</span>
                        </div>
                    </div>
                    <div className='font-[DanaFaNum] font-[500] text-[16px] leading-[100%] tracking-[0%] text-right absolute md:top-[180px] md:left-[50px] top-[210px] left-[50px] w-[245px] h-[46px] '>{t('adminApprovalMessage')}</div>
                    <div className="flex items-center gap-4 absolute md:top-[300px] md:left-[30px] top-[320px] left-[30px]">
                    
                    <motion.button
                        onClick={() => navigate('/StudentPanel/my-reserve')} 
