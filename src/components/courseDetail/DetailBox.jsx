...
import { RatingsProvider } from '../starRating/RatingContext'
    ...
    <div className='w-[50%] max-w-2xl xl:max-w-4xl h-auto p-4 sm:p-6 flex flex-col justify-between items-center gap-4'>
        <div className="w-[183px] md:w-[244px] h-[34px] md:h-[46px] font-bold text-2xl sm:text-3xl lg:text-4xl text-black mr-[-40px] md:mr-[10px] lg:mr-[0] self-start md:self-start lg:self-start whitespace-nowrap"><h2>{course?.title}</h2></div>
            ...
            <div className="lg:w-[660px] md:w-[630px] border-2 border-transparent rounded-[16px] flex flex-col gap-5 md:flex-row lg:flex-row md:border-gray-400 md:border-gray-400 lg:border-gray-400 md:gap-0 lg:gap-0">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className=" whitespace-nowrap w-[99px] h-[27px] rounded-[32px] pt-[2px] pr-[8px] pb-[2px] pl-[8px] gap-[8px] bg-blue-500 mr-7 md:mr-5 mt-1 text-white">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] border-2 flex gap-7 border-gray-400 md:border-transparent rounded-[16px]'>
                    <div>
                        <div className='flex flex-col gap-4 md:mr-[5px] lg:mr-[-30px]'>
                            <div className="md:pr-[-20px] lg:pr-[2px] mr-3 pt-2 w-[76px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-gray-800 whitespace-nowrap">سطح آموزشی</div>
                            <div className="md:mr-[10px] lg:mr-[15px] mr-3 mt-1  h-[27px] rounded-[32px] pt-[2px] pr-[8px] pb-[2px] pl-[8px] gap-[8px] bg-[#FF37F5] text-white whitespase-nowrap">{course?.courseLevelName}</div>
                        </div>
                        <div className="w-[80px] h-0 border-2 -rotate-90 border-gray-400 relative top-[-31px] left-[-120px] md:top-[-30px] md:left-[-120px] lg:left-[-90px]"></div>
                    </div>

                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className="md:pr-15 lg:pr-10 pr-15 pt-2 w-[60px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-gray-800 whitespace-nowrap">استاد دوره</div>
            ...
            <div className="w-[311px] lg:w-[311px] lg:w-[660px] md:w-[630px] md:h-[34px] h-[29px] flex justify-between">
                ...
                <div className='z-[2] flex items-center justify-end bg-white md:bg-transparent shadow-[0_-5px_10px_-7px_rgba(0,0,0,0.2)] md:shadow-none w-[200px] md:w-auto lg:w-auto h-[80px] md:h-auto fixed top-[1000px] left-0 md:static lg:static text-left'><span className="font-dana font-bold text-[24px] leading-none tracking-normal text-right">{course?.cost.toLocaleString()}</span> تومان</div>
            </div>
            
            <div className='flex gap-4'>
                <div className='md:z-0 flex items-center justify-start w-[600px] h-[80px] md:h-auto md:w-auto lg:w-auto fixed top-[1000px] right-0 md:static lg:static bg-white md:bg-transparent shadow-[0_-5px_10px_-7px_rgba(0,0,0,0.2)] md:shadow-none'>
                    <motion.button
                        onClick={openOverlay}
                ...
                <AddFavorites CourseId={CourseId} isFav={course?.isUserFavorite}/>

                <LikeDislikeToggle CourseId={CourseId} currentUserLike={course?.currentUserLike} currentUserDissLike={course?.currentUserDissLike } />
            </div>
