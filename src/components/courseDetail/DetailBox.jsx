        ...
        <div className='w-[50%] max-w-2xl xl:max-w-4xl h-auto p-4 sm:p-6 flex flex-col justify-between items-center gap-4'>
            ...
            <div className="lg:w-[660px] md:w-[630px] border-2 border-transparent rounded-[16px] flex flex-col gap-5 md:flex-row lg:flex-row md:border-gray-400 md:border-gray-400 lg:border-gray-400 md:gap-0 lg:gap-0">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div>
                        ...
                        <div className='flex flex-col gap-4'>
                            <div className="md:pr-0 pr-6 pt-2 w-[58px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-gray-800">{t('category')}</div> 
            ...
            <div className="lg:w-[100%] md:w-[630px] border-2 border-transparent rounded-[16px] flex flex-col gap-5 md:flex-row md:border-gray-400 md:gap-0">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className="md:pr-8 pr-5 pt-2 w-[58px] h-[20px] font-dana font-medium text-[14px] leading-[100%] tracking-[0%] text-right text-gray-800 whitespace-nowrap">{t('endDate')}</div>
            ...
            <div className="w-[311px] lg:w-[100%]  md:w-[630px] md:h-[34px] h-[29px] flex justify-between">
                <div className='flex gap-2 justify-center items-center'>
                    ...
                    />
                    +
                    <div>( {course?.commentCount} ){t('comments')}</div>
                </div>
                <div className='z-[2] flex items-center justify-end bg-white md:bg-transparent shadow-[0_-5px_10px_-7px_rgba(0,0,0,0.2)] md:shadow-none w-[200px] md:w-auto lg:w-auto h-[80px] md:h-auto fixed top-[1410px] left-0 md:static lg:static text-left'><span className="font-dana font-bold text-[24px] leading-none tracking-normal text-right">{course?.cost.toLocaleString()}</span> {t('toman')}</div> 
            </div>
            ...
            <div className='flex gap-4'>
                <div className='z-1 flex items-center justify-start w-[600px] h-[80px] md:h-auto md:w-auto lg:w-auto fixed top-[1410px] right-0 md:static lg:static bg-white md:bg-transparent shadow-[0_-5px_10px_-7px_rgba(0,0,0,0.2)] md:shadow-none'>
                    ...
                    >  
                        <img src={reservIcon} alt={t('reserveCourse')}/>
                        <span className='text-white whitespace-nowrap font-bold'>{t('reserveCourse')}</span> 
