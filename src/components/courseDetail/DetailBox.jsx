...
const DetailBox = ({course, CourseId}) => {
  ...
  return (
    <div className='w-[50%] max-w-2xl xl:max-w-4xl h-auto p-4 sm:p-6 flex flex-col justify-between items-center gap-4'>
        <div className=" w-[183px] md:w-[244px] h-[34px] md:h-[46px] font-bold text-2xl sm:text-3xl lg:text-4xl  mr-[-40px] md:mr-[10px] lg:mr-[-30px] self-start md:self-start lg:self-start whitespace-nowrap"><h2>{course?.title}</h2></div>
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className='w-[45px] h-[20px] font-medium text-[14px] leading-[100%] text-[var(--text-grey)] pr-3 pt-2'> وضعیت</div>
                    ...
                    <div>
                    <div className='flex flex-col gap-4'>
                        <div className="md:pr-0 pr-6 pt-2 w-[58px] h-[20px] font-dana font-medium text-[14px] text-[var(--text-grey)] leading-[100%] tracking-[0%] text-right ">دسته‌بندی</div>
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] border-2 flex gap-7 border-gray-400 md:border-transparent rounded-[16px]'>
                    <div>
                        <div className='flex flex-col gap-4 md:mr-[5px] lg:mr-[-30px]'>
                            <div className="md:pr-[-20px] lg:pr-[25px] mr-3 pt-2 w-[76px] h-[20px] font-dana text-[var(--text-grey)] font-medium text-[14px] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">سطح آموزشی</div>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className="md:pr-10 lg:pr-5 pr-15 pt-2 w-[60px] h-[20px] font-dana font-medium text-[var(--text-grey)] text-[14px] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">استاد دوره</div>
                            <div className="md:pr-5 pr-15 pt-3 w-[152px] h-[23px] top-[37px] left-[25px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">{course?.teacherName}</div>
                        </div>
                    </div>
            ...
            <div className="lg:w-[660px] md:w-[630px] border-2 border-transparent rounded-[16px] flex flex-col gap-5 md:flex-row md:border-gray-400 md:gap-0">
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] flex gap-7 border-2 border-gray-400 md:border-transparent rounded-[16px]'>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'> 
                            <div className='pr-3 pt-2 w-[45px] h-[20px] font-medium text-[14px] leading-[100%] text-[var(--text-grey)] whitespace-nowrap'>تاریخ برگزاری</div>
                            <div className="pr-3 pt-2 w-[124px] h-[23px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%]  text-right  whitespace-nowrap">{formatDate(course?.startTime)}</div>
                        </div>
                    ...
                    <div>
                    <div className='flex flex-col gap-4'>
                        <div className="md:pr-8 pr-5 pt-2 w-[58px] h-[20px] font-dana font-medium text-[14px] text-[var(--text-grey)] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">تاریخ اتمام</div>
                        <div className="md:pr-8 pr-5 pt-2 w-[96px] h-[23px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">{formatDate(course?.endTime)}</div>
                    </div>
                ...
                <div className='w-[361px] md:w-[325px] lg:w-[325px] h-[80px] border-2 flex gap-7 border-gray-400 md:border-transparent rounded-[16px]'>
                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className="pr-3 pt-2 w-[76px] h-[20px] font-dana font-medium text-[14px] text-[var(--text-grey)] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">تعداد لایک</div>
                            <div className="pr-3 pt-2 w-[47px] h-[23px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right ">{course?.likeCount}</div>
                        </div>
                    ...
                    <div>
                        <div className='flex flex-col gap-4'>
                            <div className="pr-16 pt-2 w-[60px] h-[20px] font-dana font-medium text-[14px] text-[var(--text-grey)] leading-[100%] tracking-[0%] text-right  whitespace-nowrap">تعداد دیس‌لایک</div>
                            <div className="pr-16 pt-2 w-[39px] h-[23px] top-[37px] left-[25px] font-dana font-medium text-[16px] leading-[100%] tracking-[0%] text-right ">{course?.dissLikeCount}</div>
                        </div>
                    </div>
