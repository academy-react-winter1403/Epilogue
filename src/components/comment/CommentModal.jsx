...
class Modal extends Component {
  render() {
    ...
    return (
      <div className="fixed inset-0 bg-black/40 z-40  md:backdrop-blur flex items-center justify-center z-50 ">
        <div className="flex flex-col items-center md:block relative bg-[#FCFCFC] pb-17 md:pb-0 md:rounded-[32px] p-6 w-[393px] md:w-[851px] lg:w-[851px] rounded-tl-[32px] rounded-tr-[32px]">
          ...
          <div className="flex justify-between items-center">
            <div className='flex flex-col md:flex-row gap-3 md:gap-5 justify-center items-center'>
                <h2 className="mt-5 md:mt-0 mr-4 w-[219px] md:w-[263px] h-[34px] font-dana font-bold text[20px] md:text-[24px] leading-[100%] tracking-[0%] text-right whitespace-nowrap">{title}</h2>
                ...
                >
                    ...
                    <span className='text-[#FF5353]'>بستن</span>
                </motion.button>
